  ...
  return (
    <div className="flex flex-col gap-2  max-md:py-6 max-md:w-full">
      ...
      <div className="flex flex-col md:mt-8 md:flex-row  gap-3 justify-between">
        <label
          htmlFor="Arcade"
          className={`flex flex-row md:flex-col gap-4   rounded-lg p-4 md:gap-10 md:justify-between  md:min-w-[110px] md:w-[150px] ${
            plan === "Arcade"
        ...
        <label
          htmlFor="Pro"
          className={`flex flex-row md:flex-col gap-4   rounded-lg p-4 md:gap-10 md:justify-between  md:min-w-[110px] lg:w-[150px] ${
            plan === "Pro"
              ? "bg-magnolia-color outline outline-1 outline-marine-blue"
              : "bg-transparent outline outline-1 outline-light-blue"
          }`}
