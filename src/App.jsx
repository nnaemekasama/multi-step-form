    ...
    <>
      <div>
        <div className="flex flex-col min-h-screen   items-center justify-center bg-light-blue ">
          <div className="max-md:absolute top-[115px]  max-md:z-10 max-md:w-5/6 max-md:min-w-[300px] max-md:max-w-[565px]  md:flex md:flex-row bg-white-color  md:w-2/3 md:min-w-[50rem] md:max-w-[55rem] md:h-[35rem]  rounded-lg md:p-3">
